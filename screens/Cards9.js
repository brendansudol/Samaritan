...
import Card from '../components/scratch/cards9/Card'
import EmptyState from '../components/scratch/cards9/EmptyState'
...
export default class Cards9 extends React.Component {
  constructor() {
    super()
